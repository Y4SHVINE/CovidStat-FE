export interface DailyPcrTestingData {
  date: string;
  pcr_count: string;
}

export interface DailyAntigenTestingData {
  date: string;
  antigen_count: string;
}

export interface CurrentStatData {
  ...
  daily_pcr_testing_data: DailyPcrTestingData[];
  total_antigen_testing_count: number;
  daily_antigen_testing_data: DailyAntigenTestingData[];
  hospital_data: any[];
}
